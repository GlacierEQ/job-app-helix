...
**Stack:** JavaScript/Python/TypeScript · Express + ML/AI + Next.js + React + Tailwind · DB: MongoDB, PostgreSQL, Prisma, SQLAlchemy

## 📝 NOTE: 1 uncommitted file(s) in working tree.\n\n## Project Standards

- convention in Orders_and_Rulings.md
