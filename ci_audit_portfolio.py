...
def step_2_apex_highway():
    ...
    print(
        f"Healthy Nodes: {health['healthy_nodes']}/"
        f"{health['total_nodes_discovered']} "
...
def step_3_hero_tests():
    ...
    env_tps["PYTHONPATH"] = (
        str(tps_dir / "src") + os.pathsep + env_tps.get("PYTHONPATH", "")
    )
    r_tps = subprocess.run(
...
def main():
    ...
    print("  PORTFOLIO STATUS: 100% SOLID & DEPLOYABLE")
    print("==================================================")
