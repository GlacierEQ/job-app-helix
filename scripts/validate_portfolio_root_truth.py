...
def validate() -> dict[str, Any]:
    ...
    receipt = {
        ...
        "projection_freshness": {
            ...
            "boundary": "Root validation proves source and contract integrity only. "
