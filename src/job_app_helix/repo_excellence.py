...
def _require_bound_proof_receipt(
    ...
    # Promotion authority is repository-state authority, so its source proof must be
    # bound to the exact canonical Git commit rather than merely looking digest-shaped.
