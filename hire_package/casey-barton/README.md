...
Machine metadata lives in `candidate_node.json`, `application_spiral.json`, `evidence_ledger.json`, `coordinator_candidate_receipt.json`, and `package_mesh.json`. Typed relationships use only the compiled `glaciereq.readme.v1` enum.
