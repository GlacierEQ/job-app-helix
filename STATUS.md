...
| Wave | Focus | Status |
|---|---|---|
| 0 | Control identity + program bind | ACTIVE |
| 1 | Critical hire path + leaf restores (MCP, Lambert) | ACTIVE |
...
| 5 | Atlas closure + site re-project | PENDING |
...
1. Land Wave-1 leaf restore PRs
2. Re-audit portfolio 66 for missing / neutralized / thin
3. Restore Wave-2 physics family under dual-plane truth
4. Refresh job-application helix projection and verify public site
